...
export default ({ placement = 'left', content }: ChatPopoverProps) => {
  return <>
  <div className="adm-popover adm-popover-light">
    <div className={(`adm-popover-arrow adm-popover-arrow-${placement}`)}>
      ...
      <div className={(`adm-popover-inner adm-popover-inner-${placement}`)}>
